...
| F-container | model · grouping | 🚧 | **Now** | The missing bounded-context / region primitive (vertical bands; spatial membership; derived pivotal). Model brick (S1–S3) merged in PR #8; render/serve/client UI stages remain. Decisions + plan in [`docs/F-container-scope.md`](docs/F-container-scope.md) / [`docs/F-container-plan.md`](docs/F-container-plan.md). Unlocks F-model-smells and F-ddd-process. |
