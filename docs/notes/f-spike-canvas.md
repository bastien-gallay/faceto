...
Throwaway spike for [#114]. Branch `spike/f-spike-canvas`, **not for merge**: the deliverable is
this list of constraints, plus code to read. Dated 2026-07-26.
...
baseline, and renders SVG. Try it:
